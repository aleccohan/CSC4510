...
{
  "$end", "error", "$undefined", "ID", "NUMBER", "EQUAL", "PLUS", "MULT",
  "NEWLINE", "LPAREN", "RPAREN", "$accept", "stmt_list", "stmt", "expr",
...
{
      -2,     8,    -3,     2,     0,     7,     4,    10,    -3,     2,
      -3,     6,    -3,    11,    -3,     2,     2,     4,    -3,    -3,
      10,    -3
};
...
{
       0,    12,    11,     0,     0,     0,     5,     7,     9,     0,
      12,     0,     1,     0,     2,     0,     0,     4,    10,     3,
       6,     8
};
...
{
       0,     3,     4,     9,    12,    13,    14,    15,    16,     5,
       3,    14,     0,    13,     8,     6,     7,    14,    10,     8,
      15,    16
};
...
#line 26 "calc.y" /* yacc.c:1646  */
    {var[(yyvsp[-2].var_pos)] = (yyvsp[0].val); cout << "=" << (yyvsp[0].val) << endl;}
